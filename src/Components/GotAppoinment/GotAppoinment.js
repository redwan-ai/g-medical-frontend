...
const GotAppoinment = () => {
    ...
    return (
        <div className="overflow-x-auto p-6 shadow-lg">
            <p className='text-[25px] font-[600] mb-1 text-primary text-center'>Got Appoinment</p>
            <p className='text-[15px] mb-4 text-[#FF0000] text-center'>*This route for only doctor</p>
            <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4'>
                <div className='bg-primary text-white p-3 flex flex-col gap-1 rounded-md'>
                    ...
                    <div className='mt-4 flex items-center justify-center gap-1'>
                        <button className='bg-white hover:bg-white border-0 btn btn-sm text-primary text-xs'>Confirm</button>
